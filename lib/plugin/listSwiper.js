...
/**
 * =====================================
 * Created by Chaunjie on 17/3/16.
...
(function (root, factory) {
    ...
    var TranslateZero = "translate3d(0,0,0)",
        ...
        CLASS_SWIPE_ENABLE = "swipe-enable",
        CLASS_SWIPE_RIGHT_BTN = "swipe-right-btn",
        CLASS_SWIPE_HANDLE = "swipe-handle",
        CLASS_SWIPE_TRANSITION = "swipe-transition";
    ...
    var ListSwipe = function ListSwipe() {
        var self = this;
        self.init();
    };
    ...
    ListSwipe.prototype.toggleEvents = function (element) {
        ...
        element.addEventListener('touchend', function (event) {
            ...
            if (self.getDirection(toucheEndX, toucheEndY) == 'left' && self.getDistance(firstTouchxy, touchEndxy) > btnWidth * 1.5) {
                ...
                // 菜单显示后在element父级元素增加swipe-enable，用户可以判断当前class是否存在来判断onclick事件的触发
